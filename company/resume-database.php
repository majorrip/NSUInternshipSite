                  ...
                  <table id="example2" class="table table-hover">
                    ...
                    <?php
                      ...
                      <tr>
                        ...
                        <td><a href="../uploads/resume/<?php echo $row['resume']; ?>" download="<?php echo $row['firstname'].' Resume'; ?>"><i class="fa fa-file-pdf-o"></i></a>
                        <iframe src = "../uploads/resume/<?php echo $row['resume']; ?>" allowfullscreen webkitallowfullscreen></iframe>
                        </td>
